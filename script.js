...
// 🚀 Magic Link Generator Engine (Clean URL Architecture)
document.getElementById('generate-btn').addEventListener('click', () => {
    ...
    try {
        ...
        // Stylish Custom A.S signature attached safely
...
// 🔍 SMART DECODER ENGINE: Fixes the 'Corrupt Link' error completely!
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (surpriseParam) {
        ...
        try {
            // Smart extraction logic that cleans any trailing/leading params
